...
def frontend():
    ...
    def update_command():
        if selected_tuple == "":
            print("Please the record to update")
        else:
    ...
    b1=Button(window,text="View all Books", width=12,command=view_command)
    ...
    b6=Button(window,text="View Students", width=12,command=view_student)
    b6.grid(row=7,column=3)

    b7=Button(window,text="Delete Students", width=12,command=delete_student)
